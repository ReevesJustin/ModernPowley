...
- [Modernized roadmap](docs/modernization/modern_powley_roadmap.md): gated development sequence and specification-first governance.
- [M01 canonical specification](docs/modernization/milestones/M01_canonical_inputs_and_geometry.md): accepted authorization and gates for canonical inputs and geometry.
- [M01 design](docs/modernization/phases/M01_canonical_inputs_and_geometry.md): implemented canonical inputs, units, provenance, serialization, and transparent geometry.
- [M01 completion review](docs/modernization/reviews/M01_completion_review.md): acceptance-gate mapping and remaining limits.
- [M02 canonical specification](docs/modernization/milestones/M02_powder_property_records.md): accepted authorization and gates for neutral powder-property records.
- [M02 design](docs/modernization/phases/M02_powder_property_records.md): implemented neutral powder identity, property, missingness, domain, and conflict records.
- [M02 completion review](docs/modernization/reviews/M02_completion_review.md): evidence and no-behavior acceptance mapping.
- [M03 canonical specification](docs/modernization/milestones/M03_input_and_domain_diagnostics.md): accepted authorization and gates for diagnostics.
- [M03 diagnostic design](docs/modernization/phases/M03_input_and_domain_diagnostics.md): implemented operation-relative input completeness and literal M02 domain diagnostics.
...
- [DEVA 1990 protocol provenance note](docs/modernization/reviews/deva_1990_protocol_provenance_note.md): proportionate provenance review of a real, maintainer-supplied transcription; decision `source_intake_not_ready`; no record admitted, one field redacted pending a publication decision.
- [M06 canonical specification](docs/modernization/milestones/M06_pressure_velocity_baseline.md): `planned`, unauthorized draft proposing a declared-method/baseline-record architecture with no promoted pressure or velocity method; separates software correctness from scientific validity and classifies evidence gaps by what they block.
