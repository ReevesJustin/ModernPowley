...
Its separately bounded records Phase 1 is `accepted` for immutable evidence
records, strict serialization, and fictional fixtures only. The parent
workstream remains planned; cohorts, splits, scientific intake, M05 adapters/derivation,
